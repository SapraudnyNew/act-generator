...
Правила падежей:
  signatory         — родительный падеж, полное ФИО (для шапки/вводного абзаца)
                      пример: «Мартынова Дмитрия Сергеевича»
  signatory_short   — именительный падеж, Фамилия И.О. (для строки подписи)
                      пример: «Мартынов Д.С.»
  Ссылка на материалы сессий — запрашивать отдельно для каждого счёта.
"""
...
data = {
    ...
    "client": {
        ...
        "signatory":         "Мартынова Дмитрия Сергеевича",
        "signatory_short":   "Мартынов Д.С.",
        "position":          "директора",
